...
def save_experiment(experiment_name, config, model, train_losses, test_losses, accuracies, base_dir="Percolation_shifted\\experiments"):
...
def save_checkpoint(experiment_name, model, epoch, base_dir="Percolation_shifted\\experiments"):
    outdir = os.path.join(base_dir, experiment_name)
    os.makedirs(outdir, exist_ok=True)
...
def load_experiment(experiment_name, checkpoint_name="model_final.pt", base_dir="Percolation_shifted\\experiments"):
    outdir = os.path.join(base_dir, experiment_name)
    # Load the config
    configfile = os.path.join(outdir, 'config.json')
